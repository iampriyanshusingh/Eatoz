...
router.post("/like", userMiddleware.authUser, foodController.likeFood);

router.post("/save", userMiddleware.authUser, foodController.saveFood);

router.get("/save", userMiddleware.authUser, foodController.getSaveFood);
